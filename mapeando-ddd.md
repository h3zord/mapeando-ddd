...
- Quais as ações (casos de uso) que essa aplicação deve ter?
  Resposta:
    ...
    - Adicionar informações extras, como tamanho e cor, para tornar o rastreamento ainda mais preciso;
    - Definir um limite mínimo para cada produto, de forma que pudéssemos receber um alerta quando o estoque estiver chegando próximo ao fim;
    - Receber alertas por e-mail e também por meio de uma notificação em nosso sistema de gerenciamento de estoque;
    - Visualizar histórico de vendas e estoque;
    - Gerenciar ordens de compra automaticamente:
    - Ver quantos produtos vendemos em um determinado período, qual foi o lucro gerado por produto e quais produtos estão vendendo melhor em cada período;
